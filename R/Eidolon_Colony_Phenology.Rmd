...
<<<<<<< HEAD:R/Eidolon_Colony_Phenology.Rmd
locations <- as.factor(unique(Peaks$Location))
```
...
plot(locations, r.sq_df[2,], ylab = "R^2", 
     xnt = TRUE,
     main = "", las = 2)
>>>>>>> bd377498ccb87410b5b00528d073ce37412c4254:R/Eidolon_Colony_Count_GreenUp_TRMM.Rmd
