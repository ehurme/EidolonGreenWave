...
save(avg_peaks, Peaks, Strict_Peaks, reg_colonies, Africa, file = "../../../../Dropbox/MPI/Eidolon/Greenwave/rdata/avg_peaks.RData")
...
```{r}
save(Peaks, file = "../../../../Dropbox/MPI/Eidolon/Greenwave/rdata/model_peaks.RData")
